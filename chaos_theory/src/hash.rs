...
// Code below is from https://github.com/rust-lang/rustc-hash (Apache 2.0 or MIT).
// Vendored to ensure that hash values will always be the same (for reproducibility),
// as well as to be able to tweak things as required (e.g. expose `hash_bytes`).
